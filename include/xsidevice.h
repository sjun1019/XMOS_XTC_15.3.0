...
DLL_EXPORT enum XsiStatus xsi_drive_port_pins(void *instance, const char *core,
		                                      const char *port, XsiPortData mask, XsiPortData value);
DLL_EXPORT enum XsiStatus xsi_drive_periph_pin(void *instance, const char *periph,
		                                        const char *pin, XsiPortData mask, unsigned value);
DLL_EXPORT enum XsiStatus xsi_sample_periph_pin(void *instance, const char *periph,
		                                       const char *pin, XsiPortData mask, XsiPortData *value);
