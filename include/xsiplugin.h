...
#define XSI_PLUGIN_INTERFACE_VERSION 1.2
...
struct XsiCallbacks
{
    ...
    enum XsiStatus (*drive_periph_pins)(const char *periph, const char *pin, XsiPortData mask, XsiPortData var);
    enum XsiStatus (*sample_periph_pins)(const char *periph, const char *pin, XsiPortData mask, XsiPortData *var);
    ...
    enum XsiStatus (*open_tracing_files)(const char* trace_file_path, XsiTraceInfo** tracingInfo);
};
