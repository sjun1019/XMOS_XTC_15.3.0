...
build_time_vars = {'ABIFLAGS': '',
 ...
 'ALT_SOABI': 0,
 'ANDROID_API_LEVEL': 0,
 'AR': '/var/folders/24/8k48jl6d249_n_qfxwsl6xvm0000gn/T/tmpfzwu_feg/tools/llvm/bin/llvm-ar',
 'ARFLAGS': 'rcs',
 ...
 'BLDSHARED': 'clang -bundle -undefined dynamic_lookup -arch x86_64 '
              ...
              '-L/var/folders/24/8k48jl6d249_n_qfxwsl6xvm0000gn/T/tmpfzwu_feg/tools/deps/lib',
 'BUILDEXE': '.exe',
 ...
 'CFLAGS': '-Wno-unused-result -Wsign-compare -Wunreachable-code -DNDEBUG -g '
           ...
           '/Applications/Xcode_12.4.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX11.1.sdk '
           '-fPIC '
           '-I/var/folders/24/8k48jl6d249_n_qfxwsl6xvm0000gn/T/tmpfzwu_feg/tools/deps/include '
           '-I/var/folders/24/8k48jl6d249_n_qfxwsl6xvm0000gn/T/tmpfzwu_feg/tools/deps/include/ncursesw '
           '-I/var/folders/24/8k48jl6d249_n_qfxwsl6xvm0000gn/T/tmpfzwu_feg/tools/deps/include/uuid '
 ...
 'CONFIG_ARGS': "'--build=x86_64-apple-darwin' '--host=x86_64-apple-darwin' "
                "'--prefix=/install' "
                "'--with-openssl=/var/folders/24/8k48jl6d249_n_qfxwsl6xvm0000gn/T/tmpfzwu_feg/tools/deps' "
                "'--with-system-expat' '--with-system-libmpdec' "
                "'--without-ensurepip' '--enable-shared' "
                "'--enable-optimizations' '--with-lto' "
                "'ac_cv_lib_intl_textdomain=no' 'ac_cv_func_clock_getres=no' "
                "'ac_cv_func_clock_gettime=no' 'ac_cv_func_clock_settime=no' "
                "'ac_cv_func_faccessat=no' 'ac_cv_func_fchmodat=no' "
                "'ac_cv_func_fchownat=no' 'ac_cv_func_fdopendir=no' "
                "'ac_cv_func_fstatat=no' 'ac_cv_func_futimens=no' "
                "'ac_cv_func_getentropy=no' 'ac_cv_func_linkat=no' "
                "'ac_cv_func_mkdirat=no' 'ac_cv_func_openat=no' "
                "'ac_cv_func_preadv=no' 'ac_cv_func_pwritev=no' "
                "'ac_cv_func_readlinkat=no' 'ac_cv_func_renameat=no' "
                "'ac_cv_func_symlinkat=no' 'ac_cv_func_unlinkat=no' "
                "'ac_cv_func_utimensat=no' 'ac_cv_func_mkfifoat=no' "
 ...
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/private/var/folders/24/8k48jl6d249_n_qfxwsl6xvm0000gn/T/tmpfzwu_feg/Python-3.8.16/coverage.info',
 'COVERAGE_REPORT': '/private/var/folders/24/8k48jl6d249_n_qfxwsl6xvm0000gn/T/tmpfzwu_feg/Python-3.8.16/lcov-report',
 ...
 'LLVM_PROF_MERGER': '/var/folders/24/8k48jl6d249_n_qfxwsl6xvm0000gn/T/tmpfzwu_feg/tools/llvm/bin/llvm-profdata '
 ...
 'LOCALMODLIBS': '-Xlinker -hidden-lbz2           -Xlinker -hidden-lffi '
                 ...
                 '-Xlinker -hidden-lssl -Xlinker -hidden-lcrypto     -Xlinker '
                 ...
                 'QuartzCore -Xlinker -ObjC  -Xlinker -hidden-luuid     '
                 '-Xlinker -hidden-lm    -Xlinker -hidden-lm    -Xlinker '
                 '-hidden-lexpat  -Xlinker -hidden-ledit -Xlinker '
 ...
 'MODBUILT_NAMES': '_asyncio  _bisect  _blake2  _bz2  _codecs_cn  _codecs_hk  '
                   ...
                   'parser  pyexpat  readline  resource  select  syslog  '
                   'termios  unicodedata  zlib  posix  errno  pwd  _sre  '
 ...
 'MODLIBS': '-Xlinker -hidden-lbz2           -Xlinker -hidden-lffi -Xlinker '
            ...
            '-framework QuartzCore -Xlinker -ObjC  -Xlinker -hidden-luuid     '
            '-Xlinker -hidden-lm    -Xlinker -hidden-lm    -Xlinker '
            '-hidden-lexpat  -Xlinker -hidden-ledit -Xlinker '
            '-hidden-lncurses       -Xlinker -hidden-lz',
 'MODOBJS': 'Modules/_abc.o Modules/_asynciomodule.o Modules/_bisectmodule.o '
            ...
            'Modules/grpmodule.o Modules/hashtable.o Modules/iobase.o '
 ...
 'NO_AS_NEEDED': '',
 'OBJECT_OBJS': '\\',
 'OPENSSL_INCLUDES': '-I/var/folders/24/8k48jl6d249_n_qfxwsl6xvm0000gn/T/tmpfzwu_feg/tools/deps/include',
 'OPENSSL_LDFLAGS': '-L/var/folders/24/8k48jl6d249_n_qfxwsl6xvm0000gn/T/tmpfzwu_feg/tools/deps/lib',
 ...
 'PY_CORE_CFLAGS': '-Wno-unused-result -Wsign-compare -Wunreachable-code '
                   ...
                   '-I/var/folders/24/8k48jl6d249_n_qfxwsl6xvm0000gn/T/tmpfzwu_feg/tools/deps/include/uuid '
                   '-Werror=unguarded-availability-new -flto '
                   '-Wl,-export_dynamic -g -std=c99 -Wextra -Wno-unused-result '
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': 'DYLD_LIBRARY_PATH=/private/var/folders/24/8k48jl6d249_n_qfxwsl6xvm0000gn/T/tmpfzwu_feg/Python-3.8.16',
 ...
 'TESTOPTS': '',
 'TESTPATH': '',
 'TESTPYTHON': 'DYLD_LIBRARY_PATH=/private/var/folders/24/8k48jl6d249_n_qfxwsl6xvm0000gn/T/tmpfzwu_feg/Python-3.8.16 '
               './python.exe',
 'TESTPYTHONOPTS': '',
 'TESTRUNNER': 'DYLD_LIBRARY_PATH=/private/var/folders/24/8k48jl6d249_n_qfxwsl6xvm0000gn/T/tmpfzwu_feg/Python-3.8.16 '
 ...
 'abs_builddir': '/private/var/folders/24/8k48jl6d249_n_qfxwsl6xvm0000gn/T/tmpfzwu_feg/Python-3.8.16',
 'abs_srcdir': '/private/var/folders/24/8k48jl6d249_n_qfxwsl6xvm0000gn/T/tmpfzwu_feg/Python-3.8.16',
